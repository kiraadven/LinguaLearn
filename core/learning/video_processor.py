...
from core.rendering.html_renderer import HTMLRenderer
from core.rendering.konva_renderer import KonvaRenderer
...
class VideoProcessor:
    ...
    def process_full_video(
        ...
        渲染模式优先级：
          ...
          2. 其他情况 → html_renderer PNG 渲染（Chrome Headless）
        ...
        mode_name = 'Konva (konva-node)' if use_konva else 'PNG overlay'
