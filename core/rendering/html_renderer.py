...
_PREVIEW_EXAMPLES = {
    'en': {
        ...
        'translations': {
            'zh-Hans': "语言习得是一种非凡的现象，揭示了人类心智令人难以置信的认知能力。",
    ...
    'ja': {
        ...
        'translations': {
            ...
            'zh-Hans': "语言习得是人类认知能力的显著方面，展示了大脑的适应性和可塑性。",
        },
        'words': [
    ...
    'de': {
        ...
        'translations': {
            ...
            'zh-Hans': "语言习得展示了人类大脑令人难以置信的认知适应性和神经可塑性。",
        },
        'words': [
    ...
    'ru': {
        ...
        'translations': {
            ...
            'zh-Hans': "语言习得是一种非凡的现象，展示了人类大脑的认知适应性和神经可塑性。",
        },
        'words': [
...
class HTMLRenderer:
    ...
    def render_subtitle(self, english_text: str, chinese_text: str,
        ...
        target_lang = style.get('target_lang', 'zh-Hans')
    ...
    def generate_preview_images(
        ...
        style = style or {}
        source_lang = 'zh-Hans' if str(source_lang).startswith('zh') else source_lang
