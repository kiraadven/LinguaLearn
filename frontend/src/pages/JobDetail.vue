<template>
  <div class="jd-page">
    ...
    <div v-if="!isProcessing" class="jd-topbar">
      ...
      <div v-if="activeTab === 'jingting'" style="display:flex;gap:6px">
        <button class="toggle-btn" :class="{ active: transcriptOpen && !aiTutorOpen }" @click="toggleTranscriptPanel" :title="transcriptOpen && !aiTutorOpen ? t.detail_hide_transcript : t.detail_show_transcript">
          <span>📝 字幕</span>
        </button>
        <button class="toggle-btn" :class="{ active: aiTutorOpen }" @click="toggleAiTutorPanel" title="AI互动老师">
          <span>🎓 AI老师</span>
        </button>
      </div>
    </div>
    ...
    <div v-else class="jd-body">
      ...
      <!-- ── Main row ── -->
      <div :class="['jd-main', {wide: !transcriptOpen && !aiTutorOpen}]">
        ...
        <Transition name="panel">
          <div v-if="transcriptOpen && !aiTutorOpen" class="jd-transcript-col">
            <div class="tc-header">
        ...
        <!-- AI Tutor panel (embedded in 精听 tab, beside the video) -->
        <Transition name="panel">
          <div v-if="aiTutorOpen" class="jd-transcript-col jd-ai-tutor-col">
            <InteractiveTutorTab
              :video-el="videoEl"
              :job-id="jobId"
              :segments="segments"
...
const activeTab = ref('jingting') // 'jingting' | 'podcast' | 'quiz'
