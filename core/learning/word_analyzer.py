...
class WordAnalyzer:
    def __init__(self, api_key: str = None, base_url: str = None,
        ...
        Args:
            ...
            base_url: API基础URL
            source_lang: 视频语言代码（如 'en', 'zh-Hans', 'ja'）
            target_lang: 用户母语代码（如 'zh-Hans', 'en'）
        """
        ...
        self.source_lang = aliases.get(self.source_lang, self.source_lang)
        raw_target_lang = target_lang or getattr(config, 'TARGET_LANGUAGE', 'zh-Hans')
        self.target_lang = aliases.get(raw_target_lang, raw_target_lang)
        self.is_source_cjk = self.source_lang in getattr(config, 'CJK_LANGUAGES', {'zh-Hans', 'zh-Hant', 'ja', 'ko'})
